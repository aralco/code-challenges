...
//https://github.com/PuzzlesLab/UVA/blob/master/King/00123%20Searching%20Quickly.java
//https://github.com/tanhauhau/UVa-Practice/blob/master/UVa%2000123%20Searching%20Quickly.java
//https://github.com/shailesh1001/uva-2/blob/master/UVa00123_SearchingQuickly.java
public class Main_123_SearchingQuickly {
    ...
    static class Sentence implements Comparable<Sentence>{
        ...
        Sentence (String s, String k, int pos) {
            this.keyword=k;
            this.str=s;
            this.position=pos;
        }
