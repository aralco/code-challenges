package com.cochabamba.interview.deviget.round2;

import com.cochabamba.interview.deviget.round2.services.AirlinesInfoServices;
import com.cochabamba.interview.deviget.round2.tickets.PriceTracker;
import com.cochabamba.interview.deviget.round2.tickets.PriceTrackerImpl;
...
public class FunctionalTests {
    ...
    public static void setUp() {
        ...
        allPossibleFlights = Arrays.asList(
    ...
    private static Stream<Arguments> getAvailableAirlinesForTest() {
        ...
        return Stream.of(
            Arguments.of(Arrays.asList("Airline 0", "Airline 1"), 10, 200),
            Arguments.of(Arrays.asList("Airline 2", "Airline 4", "Airline 8"), 20, 300),
            Arguments.of(Arrays.asList("Airline 0", "Airline 3", "Airline 5"), 10, 400),
            Arguments.of(Collections.emptyList(), 10, -1),
            Arguments.of(Arrays.asList("Airline 6"), 10, -1),
            Arguments.of(Arrays.asList("Airline 4", "Airline 5", "Airline 8", "Airline 9"), 10, 300),
            Arguments.of(
                Arrays.asList(
                    "Airline 0",
                    "Airline 1",
    ...
    public void basicTests(List<String> availableAirlines, int delayTime, int expectedPrice) {
