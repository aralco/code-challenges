...
public class NegateValueExpression extends UnaryExpression {

    public NegateValueExpression(Expression operand) {
        super(operand);
    }
    ...
    public int evaluate(Map<Character, Integer> arguments) {
        ...
        return Math.negateExact(operand.evaluate(arguments));
    }
}
